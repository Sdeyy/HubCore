...
public class SpeakHubCommand extends BaseCommand {
    ...
    public boolean sendMessage(CommandArgs command) {
        ...
        if (args.length == 0) {
            ...
            p.sendMessage(CC.translate("                   &d&lSpeak&5&lHub &8- [&fFileUtil&lHardling Development&8]"));
            p.sendMessage("");
            ...
            p.sendMessage(CC.translate("&7»&b /SpeakHub &fEditor &7- &fConfigure the Plugin in FileUtil Quick Way"));
            p.sendMessage(CC.translate("&8&m+----------------------------------------------+"));
