...
public class CommandFile extends YamlConfiguration {
    ...
    public CommandFile(JavaPlugin plugin, String name) {
    ...
    public String getString(String path) {
        return CC.translate(getString(path, "&bString at path &7'&3" + path + "&7' &bnot found."));
    }
